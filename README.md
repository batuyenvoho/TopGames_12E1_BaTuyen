...
* `style.css`: Quản lý giao diện và tính năng đáp ứng (Responsive).
* `script.js`: Xử lý tương tác người dùng và logic giỏ hàng.
* `/assets`: Chứa hình ảnh poster game và icons.
